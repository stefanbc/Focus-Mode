...
;(function () {
    ...
    storage.local.get(['defaultWebsites', 'customWebsites'], function (items) {
      ...
      if (items.defaultWebsites !== undefined) {
        ...
        for (var index in defaults) {
          ...
          var element = fillTemplate(listElementTemplate, {
            id: 'default' + index,
            el: website.url,
            checked: checked,
          })
      ...
      if (items.customWebsites !== undefined) {
        ...
        for (var index in customWebsites) {
          ...
          var checked = website.on ? 'checked' : ''
          var element = fillTemplate(tableElementTemplate, {
            id: 'custom' + index,
            el: website.url,
            checked: checked,
          })
  ...
  function attachEvents() {
    ...
    /* Checking event */
    var defaultCheckboxes = document
  ...
  loadWebsites()
  document
    .getElementById('addingInput')
    .addEventListener('keypress', addCustomWebsite)
})()
